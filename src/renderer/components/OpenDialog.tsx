        ...
        <div className="p-5">
          ...
          <div className="space-y-2">
            ...
            <button
              ...
              className="w-full flex items-center gap-3 p-3 rounded-lg border border-slate-200/60 dark:border-slate-800 hover:bg-slate-50 dark:hover:bg-slate-800/60 hover:border-slate-300 dark:hover:border-slate-700 transition-colors text-left"
            >
